            ...
            <div class="row">
                <div class="col-12 col-lg-1">
                    <div class="shared_comment mt-100">
                        <div class="item">
                            <div class="ttl">SHARE</div><a class="icon" href=""> <img src="common/images/shared_01.svg" alt=""/></a><a class="icon" href=""> <img src="common/images/shared_02.svg" alt=""/></a>
                        </div>
                ...
                <div class="col-12 col-lg-8 content_main">
                    ...
                    <div class="boding mt-30">
                        <p>We are making a brand-new flower for this month’s Member Make! The mokara orchid is a cross of three different types of orchids and looks stunning in bouquets, arrangements, and centerpieces. If you want to learn how to make this crepe paper mokara orchid, check out our tools and materials list below.</p>
                        <p>Once you’ve got all your supplies ready and downloaded our flower pattern, you can join me and Emily live on September 24th at 11:00 am PDT. As always, we will be giving out a prize during the live, so make sure and tune in if you can!</p>
                        <p> </p>
                        <p> <img src="common/images/detail.png" alt=""/></p>
                        <p> </p>
                        <p>We are making a brand-new flower for this month’s Member Make! The mokara orchid is a cross of three different types of orchids and looks stunning in bouquets, arrangements, and centerpieces. If you want to learn how to make this crepe paper mokara orchid, check out our tools and materials list below.</p>
                        <p>Once you’ve got all your supplies ready and downloaded our flower pattern, you can join me and Emily live on September 24th at 11:00 am PDT. As always, we will be giving out a prize during the live, so make sure and tune in if you can!</p>
                    </div>
                ...
                <div class="col-12 col-lg-3 sidebar">
                    <div class="footer">
                        <ul class="social flexBox midle">
                            <li> <a href="#"> <img src="common/images/social_01.svg" alt=""/></a></li>
                            <li> <a href="#"> <img src="common/images/social_02.svg" alt=""/></a></li>
                            <li> <a href="#"> <img src="common/images/social_03.svg" alt=""/></a></li>
                            <li> <a href="#"> <img src="common/images/social_04.svg" alt=""/></a></li>
                            <li> <a href="#"> <img src="common/images/social_05.svg" alt=""/></a></li>
                        </ul>
