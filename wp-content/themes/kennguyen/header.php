                                ...
                                <ul class="flexBox midle">
                                    <?php foreach ($primaryNav as $key => $item) {
                                        ...
                                        if ($parentCategoryCollection) {
                                            ...
                                            <li class="<?=$navClass?> nav-item dropdown toggle_parent <?= $currentCategory->parent == $parentCategoryCollection->cat_ID || $checkParentMenuActive ? 'active' : ''?>">
                                    ...
                                    <?php if (isset($_SESSION['user'])) {
                                        if (check_membership() == 2) {
                                            foreach ( $primaryNav as $navItem ) {
                                                $navClass = implode(" ", $navItem->classes);
                                                $li = '<li class="nav-item '.$navClass.'"><a class="nav-link" href="'.$navItem->url.'" title="'.$navItem->title.'">'.$navItem->title.'</a></li>';
